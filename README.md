# NFT Mobile App Automation - Katalon Project

## Project Overview

This is a **Katalon test automation project** for the NFT mobile application. The project uses Katalon Studio to automate test cases for quality assurance and continuous testing of the NFT mobile app.

**Project Name:** katalon_NFT_project  
...
| File | Purpose |
|------|---------|
| `katalon_NFT_project.prj` | Main Katalon project configuration file (XML) |
...
- Provides reusable automation logic specific to the NFT app
